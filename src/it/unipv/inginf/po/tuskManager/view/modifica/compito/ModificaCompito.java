...
//	private static Color colore_sfondo = new Color(255,178,102);
	...
	private JTuskField titolo,titolo_vecchio, descrizione,scadenza_gg,scadenza_mm,scadenza_yyyy;
	private JPanel pannello_scadenza;
	private Image img;
	public ModificaCompito(Image image, Color col_bottoni) {
		super();
		img = image;
		colore_bottoni = col_bottoni;
		this.setLayout(new BorderLayout());
		
		titolo_vecchio = new JTuskField("titolo vecchio",colore_bottoni,Color.BLACK,new Font("Arial", Font.PLAIN, 20));
		
		titolo = new JTuskField("titolo nuovo",colore_bottoni,Color.BLACK,new Font("Arial", Font.PLAIN, 20));
	...
	protected void paintComponent(Graphics g) {
		...
		titolo_vecchio.setBounds((int)(this.getSize().width/2-titolo_vecchio.getSize().width/2), (int)(this.getSize().height/2-titolo_vecchio.getSize().height*3), (int)this.getSize().width/4, (int)this.getSize().height/8);
	...
	public JTuskField getTitoloVecchio() {
