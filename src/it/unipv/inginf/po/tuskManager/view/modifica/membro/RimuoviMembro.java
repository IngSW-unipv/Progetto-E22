...
public class RimuoviMembro extends JPanel{
...
//	private static Color colore_sfondo = new Color(255,178,102);
	...
	private Image img;
	public RimuoviMembro(Image image, Color col_bottoni) {
		super();
		img = image;
		...
		bottone_invia = new JTuskButton(" rimuovi ",colore_bottoni, Color.BLACK,false,new Dimension(150,75),new Dimension(20,20));
	...
	protected void paintComponent(Graphics g) {
		...
		email.setBounds((int)(this.getSize().width/2-bottone_invia.getSize().width/2), (int)(this.getSize().height/2 - bottone_invia.getSize().height), (int)this.getSize().width/4, (int)this.getSize().height/8);
