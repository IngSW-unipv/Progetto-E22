...
//	private static Color colore_sfondo = new Color(255,178,102);
	...
	private Image img;
	public ModificaNome(Image image, Color col_bottoni) {
		super();
		img = image;
		colore_bottoni = col_bottoni;
		this.setLayout(new BorderLayout());
		nome = new JTuskField("nuovo nome",colore_bottoni,Color.BLACK,new Font("Arial", Font.PLAIN, 20));
		
		bottone_invia = new JTuskButton(" invia ",colore_bottoni, Color.BLACK,false,new Dimension(150,75),new Dimension(20,20));
	...
	protected void paintComponent(Graphics g) {
		...
		nome.setBounds((int)(this.getSize().width/2-bottone_invia.getSize().width/2), (int)(this.getSize().height/2 - bottone_invia.getSize().height), (int)this.getSize().width/4, (int)this.getSize().height/8);
		bottone_invia.setBounds((int)(this.getSize().width/2-bottone_invia.getSize().width/2), (int)(this.getSize().height/2), (int)this.getSize().width/4, (int)this.getSize().height/8);
	}
